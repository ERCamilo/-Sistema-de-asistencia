...
window.toggleEmployeePositionFilter = EmployeesUI.toggleEmployeePositionFilter;
window.toggleEmployeeLeaderFilter = EmployeesUI.toggleEmployeeLeaderFilter;
window.filterEmployeeFilterOptions = EmployeesUI.filterEmployeeFilterOptions;
window.setEmployeeFilterMenuOpen = EmployeesUI.setEmployeeFilterMenuOpen;
window.resetEmployeeFilters = EmployeesUI.resetEmployeeFilters;
window.openEmployeeForm = EmployeesUI.openEmployeeForm;
window.openEmployeeEditor = EmployeesUI.openEmployeeEditor;
window.setEmployeeSalaryView = EmployeesUI.setEmployeeSalaryView;
...
window.setLeaderSortBy = EmployeesUI.setLeaderSortBy;
    ...
    return `
        <div class="modal-overlay sync-center-overlay" data-app-close-on-self="close-modal">
            <div class="sync-center-modal" role="dialog" aria-modal="true" aria-labelledby="login-modal-title">
                ...
                <button type="button" class="google-signin-btn" data-app-fn="loginWithGoogle">
                    ...
                    <span class="google-signin-text">Iniciar sesión con Google</span>
                </button>

                <p class="login-local-note">Se abre una ventana segura de Google. Sin cuenta, la app sigue funcionando y guardando en este dispositivo.</p>
            </div>
        </div>
    `;
}
...
(async function initializeApp() {
    ...
    try {
        ...
        FirebaseService.onAuthStateChanged(async (user) => {
            ...
            // hace acá cuando el estado de auth confirma la sesión).
            if (user && state.modalType === 'login') {
                stateManager.batchSetState(() => {
                    state.showModal = false;
                    state.modalType = null;
                });
