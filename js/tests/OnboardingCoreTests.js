...
testRunner.addSuite('Onboarding v2 — núcleo (fase 1)', {
    'estado inicial con la forma del prototipo'() {
        ...
        testRunner.assertEquals([s.company, s.projectName, s.posName, s.posRate, s.newEmpName, s.newEmpCode].join('|'), '|||||', 'campos de texto vacíos');
        ...
        testRunner.assertEquals(STEPS.length + ':' + SETUP_TOTAL, '6:7', 'seis pasos de guía y siete de configuración');
    },
    'canAdvance: guía siempre, elección exige source y cada paso valida'() {
        ...
        for (const [n, patch, ok] of [
            ...
            [2, {}, false], [2, { projectName: '   ' }, false], [2, { projectName: 'Obra A' }, true],
            [3, { projectName: 'Obra A', days: [false, false, false, false, false, false, false] }, false], [3, { projectName: 'Obra A' }, true],
            [4, { projectName: 'Obra A', hours: 0 }, false], [4, { projectName: 'Obra A' }, true],
            [5, { projectName: 'Obra A' }, false], [5, { projectName: 'Obra A', posName: 'Op' }, true],
            [6, { projectName: 'Obra A' }, false], [6, { projectName: 'Obra A', employees: [{ code: '001', name: 'X' }] }, true],
            [7, { projectName: 'Obra A' }, true]
