...
describe('Payroll loan settlement UI', () => {
    ...
    test('PayrollUI wires paid confirmation into the general closure and unified employee effects', () => {
        ...
        expect(PAYROLL_UI_SOURCE).toContain('applyPayrollClosureEffects');
