 ...
 * users/{uid}/leaders. Singleton ligero: solo una suscripción activa
...
export const LeadersLiveSync = {
     ...
     * @param {(leaders: Array) => void} args.onApply Callback al recibir
     *   una nueva lista de lideres desde la nube.
     */
    start({ subscribe, onApply } = {}) {
        ...
        try {
            _unsubscribe = subscribe((leaders) => {
                try {
                    ...
                    console.error('❌ LeadersLiveSync.onApply error:', e);
                } finally {
                    if (typeof window !== 'undefined') {
                        setTimeout(() => {
            ...
            console.error('❌ LeadersLiveSync.start error:', e);
            _unsubscribe = null;
            return false;
        }
    },
...
export default LeadersLiveSync;
