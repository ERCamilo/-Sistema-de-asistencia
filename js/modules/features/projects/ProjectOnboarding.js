import { C, FIELD_STYLE, LBL, esc } from '../../ui/onboarding/OnboardingView.js';
            ...
            nextBtn.addEventListener('click', async () => {
                ...
                if (wizardState.phase === 'ready') {
                    ...
                    try {
                        ...
                        // Switch active project without reload
                        if (typeof setupService.switchActiveProject === 'function') {
                            await setupService.switchActiveProject(result.project.id);
                        }
...
export async function openProjectOnboardingModal({
    ...
    modalEl.innerHTML = `<div data-project-create-modal-slot style="max-width:680px;width:100%;margin:auto;"></div>`;
