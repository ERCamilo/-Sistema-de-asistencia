...
**Actualización F1.6 (2026-08-29):** **A0–A5 ✅ están cerrados y aprobados por Dirección 2026-08-29** — A4 2026-08-28 `6c1cb2c` (12/12 nuevos, 49/49 A4+A1+A2+A3, 365/365 · 3525, ALLOW · 0 findings; ver [`../fase-1/F1.6-A4-bitacora.md`](../fase-1/F1.6-A4-bitacora.md)) y **A5 ✅ cerrado y aprobado formalmente 2026-08-29 sobre `ae66121`** (8 archivos, +243/-4; helper 24 líneas `ExportConfigSanitizer`; 17/17, 56/56, 366/366 · 3542, ALLOW · 0 findings tras fix WARNING `Object.assign` vía `Object.assign` shallow copy); helper elimina solo `exportConfig` y preserva `payrollDefaults`/`projectPayrollConfigs`; sanea mirror/replace/snapshot + `getSnapshot`/`getFullState` + `PersistenceService` `_mirrorSnapshot` + `DataOps` frozen/`cleanCloud` + `app.js` `applyRemoteData`/`applyBackupData`/`prepareRestoredState`; verifica no resurrección tras sync/restore/snapshot con A→B→A y OFF preservadas. **A6 🟡 pendiente de veredicto formal sobre `b286d70` sobre base `792793a` (15 archivos, +532 líneas; helper `TandaBGate.js` 27 líneas; 20/20 TandaBGates + 9/9 matriz A/B; 46/46 y 85/85; 368/368 · 3571, ALLOW · 0 findings tras fix de 2 CRITICAL; ver [`../fase-1/F1.6-A6-bitacora.md`](../fase-1/F1.6-A6-bitacora.md)) · B1–B5 🔒 y F1.7 🔒 permanecen bloqueados.** DEP-SA-004 cerrado.
...
**Orden ejecutado de A6 (🟡 pendiente de veredicto formal sobre `b286d70` sobre base `792793a` — cierre de Tanda A):**
...
3. No implementar `PayrollClosure` schema3, persistencia económica por proyecto, migración de cierres, economic cloud, préstamos project-aware, PDF/SplitX. F1.7 permanece bloqueada hasta veredicto formal de A6. Estado: **A6 🟡 pendiente formal — 20/20 + 9/9, 46/46, 85/85, 368/368 · 3571, ALLOW · 0 findings tras fix de 2 CRITICAL**.
...
> **Estado exacto: A0–A5 ✅ cerrados y aprobados por Dirección 2026-08-29 (A4 `6c1cb2c` + A5 `ae66121`; A5: 17/17, 56/56, 366/366 · 3542, ALLOW · 0 findings tras fix WARNING `Object.assign` — ver `docs/fase-1/F1.6-A5-bitacora.md`) · A6 🟡 pendiente de veredicto formal sobre `b286d70` sobre base `792793a` (20/20, 9/9, 368/368 · 3571, ALLOW · 0 findings tras fix de 2 CRITICAL — ver `docs/fase-1/F1.6-A6-bitacora.md`) · B1–B5 🔒 · F1.7 🔒.** A5 ✅ cerrado y aprobado formalmente 2026-08-29; H-05 `exportConfig` sanitizado simétricamente en ALL frontiers (mirror/data/current, cloud replace, snapshots, DataOps local→cloud, restores/legacy ingresses); no borra `payrollDefaults`/`projectPayrollConfigs`; preserva A→B→A; no toca PayrollClosure/closures/loans/economic adjustments/PDF/SplitX/economic cloud/petty cash. **A6 🟡 pendiente de veredicto formal sobre `b286d70` — solicitar veredicto y detenerse antes de B1; B1–B5 🔒 y F1.7 🔒.** DEP-SA-004 cerrado.
...
| F1 Contexto de proyecto | En ejecución — F1.5 cerrada y aprobada; F1.6 en estado **A0–A5 ✅ cerrados y aprobados por Dirección 2026-08-29 (A4 `6c1cb2c` + A5 `ae66121`; A5: 17/17, 56/56, 366/366 · 3542, ALLOW · 0 findings tras fix WARNING `Object.assign`) · A6 🟡 pendiente de veredicto formal sobre `b286d70` sobre base `792793a` (20/20, 9/9, 368/368 · 3571, ALLOW tras fix de 2 CRITICAL) · B1–B5 🔒 · F1.7 🔒** (A4 12/12 nuevos, 49/49, 365/365 · 3525, ALLOW · 0 findings — ✅ cerrado 2026-08-28; A5 ✅ cerrado y aprobado 2026-08-29 sobre `ae66121`; A6 🟡 `b286d70` pendiente formal) | SA | **A6 🟡 pendiente de veredicto formal sobre `b286d70`**; B1–B5 y F1.7 bloqueados hasta aprobación de A6. DEP-SA-004 cerrado |
