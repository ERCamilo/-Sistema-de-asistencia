...
| F1 Contexto de proyecto | 🔄 En ejecución — F1.4 y F1.5 completadas (empleados/puestos/líderes/asistencia project-aware); F1.6 nómina pendiente de autorización | SA | cierre pre-F1.4 aprobado |
