...
3. No implementar `PayrollClosure` schema3, persistencia económica por proyecto, migración de cierres, economic cloud, préstamos project-aware, PDF/SplitX. F1.7 permanece bloqueada hasta cierre de A6.
...
> **Estado exacto: A0–A5 ✅ cerrados y aprobados por Dirección 2026-08-29 (A4 `6c1cb2c` + A5 `ae66121`; A5: 17/17, 56/56, 366/366 · 3542, ALLOW · 0 findings tras fix WARNING `Object.assign` — ver `docs/fase-1/F1.6-A5-bitacora.md`) · A6 🟢 autorizado exclusivamente (cierre de Tanda A) · B1–B5 🔒 · F1.7 🔒.** A5 ✅ cerrado y aprobado formalmente 2026-08-29; H-05 `exportConfig` sanitizado simétricamente en ALL frontiers (mirror/data/current, cloud replace, snapshots, DataOps local→cloud, restores/legacy ingresses); no borra `payrollDefaults`/`projectPayrollConfigs`; preserva A→B→A; no toca PayrollClosure/closures/loans/economic adjustments/PDF/SplitX/economic cloud/petty cash. **A6 🟢 autorizado exclusivamente — ejecutar gates + matriz A/B según orden congelado; B1–B5 🔒 y F1.7 🔒.** DEP-SA-004 cerrado.
...
| F1 Contexto de proyecto | En ejecución — F1.5 cerrada y aprobada; F1.6 en estado **A0–A5 ✅ cerrados y aprobados por Dirección 2026-08-29 (A4 `6c1cb2c` + A5 `ae66121`; A5: 17/17, 56/56, 366/366 · 3542, ALLOW · 0 findings tras fix WARNING `Object.assign`) · A6 🟢 autorizado exclusivamente (cierre de Tanda A) · B1–B5 🔒 · F1.7 🔒** (A4 12/12 nuevos, 49/49, 365/365 · 3525, ALLOW · 0 findings — ✅ cerrado 2026-08-28; A5 ✅ cerrado y aprobado 2026-08-29 sobre `ae66121`) | SA | **A6 🟢 es el siguiente paso (cierre de Tanda A)**; B1–B5 y F1.7 bloqueados. DEP-SA-004 cerrado |
