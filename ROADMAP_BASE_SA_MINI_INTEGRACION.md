...
**Actualización F1.6 (2026-08-28 — F1.6-A2 🟡 Implementado y técnicamente validado el 2026-08-28 — pendiente de cierre formal (d5858dc; 7/7, 362/362 · 3502, ALLOW 0 findings); DEP-SA-004 ✅ Cerrado y aprobado 2026-08-27):** la arquitectura de nómina multiproyecto está aprobada con la modificación bloqueante DEP-SA-004. **A0 está ✅ Cerrado y aprobado por Dirección el 2026-08-26** (`c7a9e0c` + `333a516`; RecordKey 13/13, F1.4+A0 12/12, 76 acotados, 354/354 · 3409 PASS, fresh ALLOW; contrato congelado `explicit > default autoritativo > legacy-unresolved:*`); **A0.5 / DEP-SA-004 está ✅ Cerrado y aprobado por Dirección el 2026-08-27** — `51a7611` + `50343ee` (20/20, 360/360 · 3485 · 86s, ALLOW 0 findings; MC1+MC2 resueltos — ver [`docs/fase-1/F1.6-A0.5-bitacora.md`](docs/fase-1/F1.6-A0.5-bitacora.md) §3.1) — `activeProjectId` local, `projectId` canónico account-level. **A1 — PayrollProjectContext está ✅ Cerrado y aprobado por Dirección el 2026-08-28** (`185e1cd`; 10/10, 55/55 · 361/361 · 3495, ALLOW 0 findings — ver [`docs/fase-1/F1.6-A1-bitacora.md`](docs/fase-1/F1.6-A1-bitacora.md) §3); sin wiring. **A2 — `projectPayrollConfigs` está 🟡 Implementado y técnicamente validado el 2026-08-28** (`d5858dc`; 7/7, 362/362 · 3502, ALLOW 0 findings — ver [`docs/fase-1/F1.6-A2-bitacora.md`](docs/fase-1/F1.6-A2-bitacora.md) §3) — **pendiente de cierre formal**; local-only, sin cloud, sin wiring. **A3–A6 y F1.7 permanecen bloqueadas.** Ver [`docs/fase-1/F1.6-A2-bitacora.md`](docs/fase-1/F1.6-A2-bitacora.md).
...
| DEP-SA-004 | SA | SA (valida Dirección) | F1.6-A3–A6, estado económico durable por `projectId` más allá de A2 y F1.6-B cloud | Identidad canónica de `Project` entre dispositivos: la misma cuenta/obra debe compartir un único `projectId`; `activeProjectId` sigue siendo local. Registro, adopción/promoción y protección contra carreras mínimos y SA-only; no incluye organizaciones, roles, membresías, Mini ni Integración | Bloqueante para A3–A6 (A2 autorizado) | **✅ Cerrado y aprobado por Dirección el 2026-08-27** — `51a7611` + `50343ee` (20/20, 360/360 · 3485, ALLOW 0 findings; MC1 purga `asistencia_canonical_*`/`asistencia_alias_*` + MC2 `pending\|\|dead` — ver [`docs/fase-1/F1.6-A0.5-bitacora.md`](docs/fase-1/F1.6-A0.5-bitacora.md) §3.1) sobre **A0 ✅ Cerrado y aprobado (c7a9e0c + 333a516; 354/354 · 3409 PASS)**; **A1 ✅ Cerrado y aprobado por Dirección el 2026-08-28 (`185e1cd`; 10/10, 55/55 · 361/361 · 3495, ALLOW 0 findings)** — **A2 🟢 Autorizado (projectPayrollConfigs)**; A3–A6 bloqueadas — DEP-SA-004 cerrado |
