...
**Actualización F1.6 (2026-08-27 — cierre formal A0.5 + micro-cierre `50343ee`, DEP-SA-004 ✅ Cerrado y aprobado):** la arquitectura de nómina multiproyecto está aprobada con la modificación bloqueante DEP-SA-004. **A0 está ✅ Cerrado y aprobado por Dirección el 2026-08-26** (`c7a9e0c` + `333a516`; RecordKey 13/13, F1.4+A0 12/12, 76 acotados, 354/354 · 3409 PASS, fresh ALLOW; contrato congelado `explicit > default autoritativo > legacy-unresolved:*`); **A0.5 / DEP-SA-004 está ✅ Cerrado y aprobado por Dirección el 2026-08-27** — `51a7611` + `50343ee` (20/20, 360/360 · 3485 · 86s, ALLOW 0 findings; MC1+MC2 resueltos — ver [`docs/fase-1/F1.6-A0.5-bitacora.md`](docs/fase-1/F1.6-A0.5-bitacora.md) §3.1) — `activeProjectId` local, `projectId` canónico account-level. **A1 está 🟢 Autorizado — PayrollProjectContext (Dirección 2026-08-27); A2–A6 y F1.7 permanecen bloqueadas;** F1.6 no está completa más allá de A1. Ver [`docs/fase-1/F1.6-A0.5-bitacora.md`](docs/fase-1/F1.6-A0.5-bitacora.md).
