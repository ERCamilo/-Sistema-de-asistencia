...
1. Leer roadmap §12–§16, este índice, [`F1.6-nomina-multiproyecto.md`](F1.6-nomina-multiproyecto.md) y las bitácoras evaluables [`F1.6-A0-bitacora.md`](F1.6-A0-bitacora.md), [`F1.6-A0.5-bitacora.md`](F1.6-A0.5-bitacora.md) y [`F1.6-A1-bitacora.md`](F1.6-A1-bitacora.md).
2. Estado: F0 al 100%; F1.1–F1.5 cerradas; **F1.6 con arquitectura aprobada con modificación DEP-SA-004, A0 ✅ Cerrado y aprobado por Dirección el 2026-08-26** (`c7a9e0c` + `333a516`; RecordKey 13/13, 76 acotados, 354/354 · 3409, fresh ALLOW; contrato `explicit > default autoritativo > legacy-unresolved:*`) y **A0.5 / DEP-SA-004 ✅ Cerrado y aprobado por Dirección el 2026-08-27** — `51a7611` + `50343ee` (20/20, 360/360 · 3485, ALLOW 0 findings; MC1+MC2 resueltos §3.1; DEP-SA-004 cerrado) — `activeProjectId` local, `projectId` canónico account-level; **A1 🟡 Implementado y técnicamente validado el 2026-08-28** (`185e1cd`; 10/10, 55/55 · 361/361 · 3495, ALLOW 0 findings) — pendiente revisión formal; **A2–A6 y F1.7 bloqueadas**.
3. Próxima acción: **Revisión formal de A1** (ver [`F1.6-A1-bitacora.md`](F1.6-A1-bitacora.md) §3–§4 — 10/10, 55/55, 361/361 · 3495, ALLOW 0 findings, sin wiring) antes de implementar **A2 — store `projectPayrollConfigs`**. Mantener **A2–A6 y F1.7 bloqueadas** hasta veredicto formal de A1; no implementar todavía configuración cloud ni comportamiento económico F1.6-B más allá de A1. **A0 y A0.5 ya están cerrados — no requieren nueva revisión.**
