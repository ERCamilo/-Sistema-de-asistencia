...
3. Próxima acción: **Implementar A2 — store `projectPayrollConfigs` + semilla atómica + no dual-write** (ver [`F1.6-A1-bitacora.md`](F1.6-A1-bitacora.md) §3–§4 y [`F1.6-nomina-multiproyecto.md`](F1.6-nomina-multiproyecto.md) §5 — A1 ✅ Cerrado 2026-08-28, 10/10, 55/55, 361/361 · 3495, ALLOW 0 findings, sin wiring; **A2 🟢 Autorizado**). Mantener **A3–A6 y F1.7 bloqueadas** hasta avance ordenado de A2; no implementar todavía configuración cloud ni comportamiento económico F1.6-B más allá de A2. **A0, A0.5 y A1 ya están cerrados — no requieren nueva revisión.**
