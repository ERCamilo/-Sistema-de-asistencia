...
| Estado | **F0 100%; F1.1–F1.5 cerradas; A0–A6 ✅ aprobados y Tanda A ✅ completa** · **B1 ✅ cerrada y aprobada · B2 🟢 autorizada exclusivamente, no iniciada · B3–B5 🔒 · F1.7 🔒** |
| Punto de parada | Ejecutar únicamente B2 dentro de su alcance local project-scoped; **no afirmar inicio hasta que exista trabajo funcional**. B3–B5 y F1.7 permanecen bloqueadas. |
| Rama de trabajo | `feature/factor-dias-no-laborables` · SHA funcional remoto `193273e804b1f21aca46939bfc2ad631282e4c15` sobre base `f735dd6f3a4bda67688a76bb6cb11ee47e32833f`; publicación verificada exactamente |
...
| **F1.6 Nómina multiproyecto** | [`F1.6-nomina-multiproyecto.md`](F1.6-nomina-multiproyecto.md) | **A0–A6 ✅; Tanda A ✅ completa; B1 ✅; B2 🟢 autorizada exclusivamente y no iniciada; B3–B5 🔒** | F1.7 🔒; ejecutar solo B2 |
...
| **F1.6-B1 PayrollClosure schema 3 project-aware** | [`F1.6-B1-bitacora.md`](F1.6-B1-bitacora.md) | ✅ **Cerrada y aprobada formalmente en `193273e`.** 41/41, 129/129, 3586/3586; `R3-001` corregido; remoto verificado; excepción limitada a la publicación B1. | B2 🟢 exclusiva; B3–B5/F1.7 🔒 |
| **F1.6-B2 Persistencia local project-scoped** | [`F1.6-nomina-multiproyecto.md`](F1.6-nomina-multiproyecto.md#tanda-b--economía-durable-y-recuperación) | 🟢 **Autorizada exclusivamente; implementación no iniciada.** Store, consultas, cachés, historial, paginación, período, `getById`, sync state y migración aislados por `projectId`; stamper schema 2→3 reanudable/idempotente en lotes pequeños; promoción legacy metadata-only al default. | Excluye B3–B5 y F1.7 |
...
1. Leer roadmap §12–§16, este índice, [`F1.6-nomina-multiproyecto.md`](F1.6-nomina-multiproyecto.md), [`F1.6-B1-bitacora.md`](F1.6-B1-bitacora.md) y el registro de [`EXC-REVIEW-B1-001`](../revisiones/B1-review-infrastructure-block.md).
2. Estado exacto: **A0–A6 ✅; Tanda A ✅ completa; B1 ✅; B2 🟢 autorizada exclusivamente y no iniciada; B3–B5 🔒; F1.7 🔒.**
3. Próxima acción: implementar solo B2 bajo protocolo Gentle AI ordinario. Si reaparece un defecto de infraestructura, detenerse y reportarlo; no reutilizar `EXC-REVIEW-B1-001`.
