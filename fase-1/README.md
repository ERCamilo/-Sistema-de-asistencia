...
| Estado | **F0 100%; F1.1–F1.5 cerradas; A0–A6 ✅ aprobados y Tanda A ✅ completa** (24/24, 9/9, 368/368 · 3575, MC1 ALLOW · 0 findings) · **B1 🟢 autorizada exclusivamente · B2–B5 🔒 · F1.7 🔒** |
| Punto de parada | MC1 resolvió las lecturas públicas ungated `getById`/`getSyncStates`; **A6 está aprobada y B1 es la única unidad autorizada**: schema 3, `projectId` inmutable e identidades/fingerprints/IDs de cierres project-aware. |
| Rama de trabajo | `feature/factor-dias-no-laborables` · SHA funcional actual remoto `f735dd6` (A6 principal `b286d70`, base `792793a`) · documentación A6/MC1 publicada en `project-docs` como `c5b2f686` |
...
| **F1.6 Nómina multiproyecto** | [`F1.6-nomina-multiproyecto.md`](F1.6-nomina-multiproyecto.md) | **A0–A6 ✅ aprobados; Tanda A ✅ completa** (24/24, 9/9, 62/62, 368/368 · 3575, MC1 ALLOW 0 findings) · **B1 🟢 exclusiva · B2–B5 🔒** | F1.7 🔒; B1 limitada a schema 3, `projectId` inmutable e identidades/fingerprints/IDs de cierres |
...
- **A6 + MC1 (✅ cierre formal)** → [`F1.6-A6-bitacora.md`](F1.6-A6-bitacora.md) — rango `792793a..f735dd6`; `b286d70` principal y `f735dd6` cierra las lecturas directas `getById`/`getSyncStates`. Evidencia final 24/24 + 9/9, 62/62, 368/368 · 3575, MC1 ALLOW 0 findings; **habilita exclusivamente B1**.
...
2. Estado exacto: **A0–A6 ✅; Tanda A ✅ completa; 24/24, 9/9, 62/62, 368/368 · 3575, MC1 ALLOW 0 findings; B1 🟢 exclusiva; B2–B5 🔒 y F1.7 🔒.**
3. Próxima acción: ejecutar exclusivamente B1 sobre `PayrollClosure` schema 3, `projectId` inmutable e identidades/fingerprints/IDs de cierres project-aware; detenerse antes de B2.
