...
| Estado | **F0 100%; F1.1–F1.5 cerradas; A0–A6 ✅ aprobados y Tanda A ✅ completa** · **B1 🟡 publicada bajo `EXC-REVIEW-B1-001`, pendiente de aprobación formal · B2–B5 🔒 · F1.7 🔒** |
| Punto de parada | B1 está publicada en remoto y técnicamente aprobada tras corregir `R3-001`; **esperar revisión formal de Dirección y no iniciar B2**. |
...
| **F1.6 Nómina multiproyecto** | [`F1.6-nomina-multiproyecto.md`](F1.6-nomina-multiproyecto.md) | **A0–A6 ✅; Tanda A ✅ completa; B1 🟡 publicada bajo excepción y pendiente de aprobación formal; B2–B5 🔒** | F1.7 🔒; esperar Dirección, no iniciar B2 |
...
- **B1 (🟡 publicada, aprobación formal pendiente)** → [`F1.6-B1-bitacora.md`](F1.6-B1-bitacora.md) — `193273e` sobre `f735dd6`, schema 3 ON project-aware y schema 2 OFF exacto; 41/41, 129/129, 3586/3586; publicación excepcional `EXC-REVIEW-B1-001`; **no habilita B2**.
...
2. Estado exacto: **A0–A6 ✅; Tanda A ✅ completa; B1 🟡 publicada en `193273e` bajo `EXC-REVIEW-B1-001`, pendiente de aprobación formal; B2–B5 🔒 y F1.7 🔒.**
3. Próxima acción: revisar remotamente B1 y esperar el veredicto formal de Dirección; **no iniciar B2**.
